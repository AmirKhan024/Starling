...
Generated 2026-09-22 18:12:39 by `scripts/review_demo.py` (commit `61869f4`). Same content as `review.html`, without images (file names refer to `review/screenshots/`). The centralized system is a comparison, not part of Starling.
